...
public class Main {
    public static void main(String[] args) throws ExceptionHealth {
        ...
        Assassin Hayabusa = new Assassin("Hayabusa", 110, 70);
        Mage Pharsa = new Mage("Pharsa", 120, 60);

        Hayabusa.useSkill(Pharsa);
            ...
            switch (pilihan) {
                case "1": // Serang
                    ...
                    if (attacker != null && target != null && attacker.isAlive()) {
                        ...
                        GameUtils.pause(6000);
                    }
                    break;

                case "2": // Skill Khusus
                    Hero heroSkill = selectHero(kumpulanHero, inputUser, "Who uses skill?");
                    Hero heroSkilled = selectHero(kumpulanHero, inputUser, "to who");
                    if (heroSkill != null && heroSkill.isAlive()) {
                        heroSkill.useSkill(heroSkilled);
                    }
                    break;
