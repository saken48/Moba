...
public abstract class Hero implements ITakeDamaged, IAttack, ISkill {
    ...
    protected void takeDamage(double physicalAttackMagic) {
        this.health -= physicalAttackMagic;
    }
    ...
    public void useSkill(Hero target) {
        System.out.println("default skill");
    }
